...
import { Button, Heading, Text, Flex, Link } from '@siacashcoin/uikit'
        ...
        <Flex flexDirection={['column-reverse', 'row']}>
          <Left>
            ...
            <Text bold fontSize="16px" color="textSubtle" mb="24px">
              {t('Each week, qualifying projects can bid AMF for the right to host a 7-day Farm.')}
            </Text>
            <Link external href='https://t.me/AmstaffSwapChat'>
              <Button>
